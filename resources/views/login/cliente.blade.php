...
<section class="container container-cuenta"> 
    <p>Home >> Log-in / Cliente</p>
    <section class="container-registro">
    <h4>Log-in</h4>
        <section class="login">
            <section class="login-step">
                <h5 class="bold">Ingresa como cliente</h5>
            ...
            <section class="login-create">
                <h5 class="bold">Nuevo cliente?</h5>
                <p>Crearse una cuenta tiene muchos beneficios</p>
                <ul>
                    <li>• Pagar más rápido</li>
                    <li>• Tener más de una dirección</li>
                    <li>• Seguimiento de pedido y más</li>
                </ul>
